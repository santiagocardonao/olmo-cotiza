...
const STRINGS = {
  es: {
    ...
    units: (q) => `${q} unidades`,
    onDemand: "según lo que pidas, se factura al ejecutarse",
    minMonths: (m) => `compromiso mínimo de ${m} ${m === "1" ? "mes" : "meses"}`,
    ofBase: "de",
    minimum: "mínimo",
    paidToProvider: "se paga al proveedor",
    oneTime: "pago único",
    estimatedRange: "rango estimado, se cierra antes de empezar",
    or: "ó",
    diagnosisPill: "Diagnóstico",
    conditionsPill: "Condiciones",
    conditionsHeading: "Sin letra",
    conditionsAccent: "pequeña.",
  ...
  en: {
    ...
    units: (q) => `${q} units`,
    onDemand: "on demand, billed once delivered",
    minMonths: (m) => `${m}-month minimum commitment`,
    ofBase: "of",
    minimum: "minimum",
    paidToProvider: "paid to the provider",
    oneTime: "one-time",
    estimatedRange: "estimated range, fixed before we start",
    or: "or",
    diagnosisPill: "Diagnosis",
    conditionsPill: "Terms",
    conditionsHeading: "No fine",
    conditionsAccent: "print.",
